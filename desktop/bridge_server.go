...
func (a *App) ensureBridgeServer() error {
	...
	registerAdvancedProxyBridgeRoute(mux, "/advanced-proxy/grokbuild/v1/chat/completions", "grokbuild.chat", a.handleAdvancedProxyGrokBuild)
	registerAdvancedProxyBridgeRoute(mux, "/advanced-proxy/grokbuild/v1/responses", "grokbuild.responses", a.handleAdvancedProxyGrokBuild)
	registerAdvancedProxyBridgeRoute(mux, "/advanced-proxy/grokbuild/v1/responses/compact", "grokbuild.responses_compact", a.handleAdvancedProxyGrokBuild)
