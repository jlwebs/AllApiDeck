                ...
                <a-tab-pane key="2" tab="常规设置">
                  <div style="padding: 10px;">
                    ...
                    <a-space direction="vertical" style="width: 100%; margin-bottom: 16px;">
                      <a-radio-group v-model:value="desktopTokenSourceMode" :disabled="!isWailsRuntime">
                        <a-radio value="profile_file">Profile 文件</a-radio>
                        <a-radio value="cdp_restart">CDP 重开模式</a-radio>
                      </a-radio-group>
                      <div style="font-size: 12px; color: #8c8c8c; line-height: 1.7;">
                        ...
                        <div v-else-if="desktopTokenSourceMode === 'profile_file' && !isChromeProfileAuthAvailable">当前桌面端尚未暴露 Profile 文件提取接口，无法使用该模式。</div>
                      </div>
                    </a-space>
                    <p><b>界面选项</b></p>
                ...
                <a-tab-pane key="3" tab="日志">
                  <div style="padding: 10px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                      <div style="font-weight: 600;">运行日志</div>
                      <a-button size="small" @click="loadDesktopLogs" :loading="desktopLogsLoading" :disabled="!isDesktopLogAvailable">
                        刷新
                      </a-button>
                    </div>
                    <div v-if="!isWailsRuntime || !isDesktopLogAvailable" style="color: #8c8c8c; font-size: 12px; line-height: 1.7;">
                      当前环境不支持桌面端日志查看，请在 EXE 中使用。
                    </div>
                    <template v-else>
                      <a-space direction="vertical" style="width: 100%;">
                        <div>
                          <div style="font-size: 12px; color: #8c8c8c; margin-bottom: 6px;">分组</div>
                        ...
                        <div>
                          <div style="font-size: 12px; color: #8c8c8c; margin-bottom: 6px;">文件</div>
                          <a-select
                        ...
                        <div v-if="currentDesktopLogFileMeta" style="font-size: 12px; color: #8c8c8c;">
